...
namespace CGPG
{
    public static class ImageUtils
    {
        ...
        public static byte[] FlipImageVertically(
            byte[] imageData,
            int width,
            int height)
        {
            ...
            for (int y = 0; y < height; y++) //row
            {
                ...
                {
                    int srcIndex = (y * height + x) * 4; //rgba of the pixel
                    int destIndex = ((height - y - 1) * height + x) * 4; //change rgba of another pixel

                    flippedData[destIndex] = imageData[srcIndex]; //r
                    flippedData[destIndex + 1] = imageData[srcIndex + 1]; //g
                    flippedData[destIndex + 2] = imageData[srcIndex + 2]; //b
                    flippedData[destIndex + 3] = imageData[srcIndex + 3]; //a
                }
            }
